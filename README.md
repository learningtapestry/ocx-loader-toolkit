...
1. In [Google Cloud Console](https://console.cloud.google.com/), create or select a project and enable the **Google Classroom API**.
...
Teachers choose **Sync with Google Classroom** on the public bundle page. Phase 1 creates a placeholder course named **OCX Loader Export** in the consenting user's Classroom account.
